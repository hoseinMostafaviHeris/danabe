package ir.storming.repository;

import ir.storming.DanaApp;

import ir.storming.config.Constants;
import ir.storming.config.audit.AuditEventConverter;
import ir.storming.domain.PersistentAuditEvent;
...
import static ir.storming.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
