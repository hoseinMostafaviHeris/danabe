...
import ir.storming.DanaApp;
import ir.storming.config.Constants;
import ir.storming.domain.User;
import ir.storming.repository.AuthorityRepository;
...
import ir.storming.service.dto.PasswordChangeDTO;
import ir.storming.service.dto.UserDTO;
import ir.storming.web.rest.vm.KeyAndPasswordVM;
import ir.storming.web.rest.vm.ManagedUserVM;
...
import static ir.storming.web.rest.AccountResourceIT.TEST_USER_LOGIN;
...
@SpringBootTest(classes = DanaApp.class)
